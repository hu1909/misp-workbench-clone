...
def upgrade():
    ...
    op.add_column(
        "feeds", sa.Column("event_uuid", postgresql.UUID(as_uuid=True), nullable=True)
    )
...
def downgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "proposal_email_lock", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column("locked", sa.Boolean(), nullable=False, server_default="false"),
        sa.Column(
            "publish_timestamp", sa.Integer(), nullable=False, server_default="0"
        ),
    ...
    op.add_column(
        "object_references", sa.Column("event_id", sa.Integer(), nullable=False)
    )
